...
mlan_status wlan_handle_event_multi_chan_info(IN pmlan_private pmpriv,
					      pmlan_buffer pevent);
inline void wlan_update_port_status(pmlan_adapter pmadapter, t_u32 port,
				    t_u8 status);
inline t_u8 wlan_is_port_ready(IN pmlan_adapter pmadapter, t_u32 port_index);
inline t_u8 wlan_usb_data_sent(IN pmlan_adapter pmadapter);
void wlan_resync_usb_port(pmlan_adapter pmadapter);
inline t_u8 wlan_get_port_index(pmlan_adapter pmadapter, t_u32 port);
...
mlan_status wlan_cmd_packet_aggr_ctrl(IN pmlan_private pmpriv,
				      ...
				      IN t_u16 cmd_action,
				      IN t_void *pdata_buf);
mlan_status wlan_ret_packet_aggr_ctrl(IN pmlan_private pmpriv,
				      IN HostCmd_DS_COMMAND *resp,
				      IN mlan_ioctl_req *pioctl_buf);
...
mlan_status wlan_set_mef_entry(IN mlan_private *pmpriv,
			       IN pmlan_adapter pmadapter, IN mef_cfg *pmef);
mlan_status wlan_process_mef_cfg_cmd(IN mlan_private *pmpriv,
				     IN pmlan_adapter pmadapter);
mlan_status wlan_misc_ioctl_mef_flt_cfg(IN pmlan_adapter pmadapter,
					IN pmlan_ioctl_req pioctl_req);
